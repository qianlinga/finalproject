...
//	}
	...
	private void initialize() {
		...
		scrollPane_1.setBounds(297, 607, 827, 185);
		...
		btnNewButton_4.setBounds(1158, 669, 197, 55);
...
//					con1 = DriverManager.getConnection(url, username, password);
		...
		btnNewButton_5.setBounds(630, 60, 192, 56);
...
//		});
		...
		textField_3.setBounds(1099, 75, 96, 30);
...
//					insert.setString(5,Position);
		...
		JLabel lblNewLabel_2 = new JLabel("購物車");
		lblNewLabel_2.setFont(new Font("新細明體", Font.PLAIN, 40));
		lblNewLabel_2.setBounds(139, 609, 120, 55);
