...
public class menu {
	...
	private void initialize() {
		...
		scrollPane_1.setBounds(33, 636, 619, 142);
		...
		btnNewButton_4.setBounds(700, 670, 176, 55);
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					con1 = DriverManager.getConnection(url, username, password);
					insert = con1.prepareStatement("INSERT INTO `Cart`(`Name`, `Price`, `Type`, `Genre`) VALUES (?,?,?,?)");
					insert.setString(1,name);
					insert.setInt(2, price);
					insert.setString(3,type);
					insert.setString(4,genre);
					...
					JOptionPane.showMessageDialog(btnNewButton, "成功加入");
...
//					con1 = DriverManager.getConnection(url, username, password);
		...
		btnNewButton_5.setBounds(915, 669, 192, 56);
		...
		JButton btnNewButton_5_1 = new JButton("刪除購物車");
		btnNewButton_5_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//insert.setInt(1, id);
					insert.executeUpdate();
					JOptionPane.showMessageDialog(btnNewButton, "刪除成功");
...
//					insert.setString(5,Position);
		...
		btnNewButton_5_1.setBounds(1142, 670, 192, 56);
		frame.getContentPane().add(btnNewButton_5_1);
		
		
		JLabel lblNewLabel_6 = new JLabel("ID");
		lblNewLabel_6.setFont(new Font("新細明體", Font.PLAIN, 25));
		lblNewLabel_6.setBounds(1152, 741, 61, 38);
